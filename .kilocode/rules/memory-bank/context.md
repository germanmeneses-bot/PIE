...
Video silencioso del pupitre inteligente con **movimiento 3D** (órbita, dolly, perspectiva, transiciones dinámicas). Assets en `public/` y página `/pupitre-inteligente`. Script: `scripts/build_pupitre_3d_video.py`.
